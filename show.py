...
def visualize_boxes(image, boxes, labels, scores, class_labels, masks=None,
    ...
    image=visualize_boxes_and_labels_on_image_array(image, boxes, labels, scores, category_index, instance_masks=masks, agnostic_mode=agnostic_mode, max_boxes_to_draw=max_boxes_to_draw, auto_show=auto_show, groundtruth_box_visualization_color=groundtruth_box_visualization_color,
            title=title)
    return image
...
def visualize_boxes_and_labels_on_image_array(
    ...
    Args:
        ...
        scores: a numpy array of shape [N] or None.    If scores=None, then
            ...
            boxes and plot all boxes as black with no labels or scores.
    ...
    for box, color in box_to_color_map.items():
        # NOTE pay attention to your bboxes 
...
if __name__ == '__main__':
    ...
    imshow = plt.imread('COCO2017/train2014/COCO_train2014_000000000009.jpg')
